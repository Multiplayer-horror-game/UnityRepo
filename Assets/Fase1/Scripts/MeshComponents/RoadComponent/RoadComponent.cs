...
namespace Fase1.MeshComponents
{
    public class RoadComponent : IMeshComponent
    {
        ...
        private Dictionary<Vector3, float> _controlPoints = new();
        ...
        public new MeshComponentData[] GenerateMeshData(Vector2Int chunkPosition, int verticesCount, float physicalSize)
        {
        ...
        {
            return _controlPoints.ElementAt(index);
        }
    }
}