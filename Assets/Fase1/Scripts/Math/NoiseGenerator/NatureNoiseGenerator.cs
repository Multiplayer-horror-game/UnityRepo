...
namespace Fase1.Math
{
    ...
    {
        public NatureNoiseGenerator(float scale, int xOffset, int yOffset, int vertices, float heightMultiplier, float heightOffset, int physicalSize) : base(scale, xOffset, yOffset, vertices, heightMultiplier, heightOffset, physicalSize)
        {
        ...
        //
        public Dictionary<Vector3, float> GenerateObjectOffsets(int xChunk, int yChunk)
        {
